...
public:
    ...
    bool is_window_hovered(ImGuiHoveredFlags flags = 0);

    bool is_window_focused(ImGuiFocusedFlags flags = 0);
    ...
    widget_t register_item(std::string_view name, const ImVec2& size);
    ...
    void render();
    std::string lang(std::string ru, std::string en);
